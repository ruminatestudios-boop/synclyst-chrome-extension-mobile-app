...
const host_permissions = [
  ...SELLER_HOST_MATCHES,
  "https://synclyst.app/*",
  /** Chrome Extension companion app (app.synclyst.app = synclystchrome Vercel project). */
...
const snapBridgeMatches = isDev
  ...
  : [
      "https://synclyst.app/snap*",
      "https://synclyst.app/extension-review*",
      "https://app.synclyst.app/snap*",
      "https://app.synclyst.app/extension-review*",
      "https://*.vercel.app/snap*",
      "https://*.vercel.app/extension-review*",
    ];
...
const tierBridgeMatches = isDev
  ...
  : ["https://synclyst.app/*", "https://app.synclyst.app/*"];
...
const extensionPagesCsp = isDev
  ...
  : "script-src 'self'; object-src 'self'; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https://*.supabase.co; connect-src 'self' https://synclyst.app https://app.synclyst.app https://*.vercel.app https://*.supabase.co wss://*.supabase.co";
